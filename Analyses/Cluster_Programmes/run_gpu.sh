...
PATHOGENS=("Metapneumovirus" "Adenovirus" "Parainfluenza3" "InfluenzaA" "InfluenzaB")
...
python -u Analyses/fit_opt.py $CURRENT_PATHOGEN 260320 Exponential mimm flexagep01 1e-9 200 1000 0.7