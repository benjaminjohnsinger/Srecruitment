...
# # print("Top 5 incidence values before 2020-03-19:", top5_indices)
# # find time of peak in 2021-22, 2022-23, 2023-24, 2024-25 seasons
# post_2021_22 = incidence.loc[(incidence.index >= pd.to_datetime("2021-10-01")) & (incidence.index < pd.to_datetime("2022-10-01"))]
# post_2021_22_peak = post_2021_22['Total'].idxmax()

# post_2022_23 = incidence.loc[(incidence.index >= pd.to_datetime("2022-10-01")) & (incidence.index < pd.to_datetime("2023-10-01"))]
# post_2022_23_peak = post_2022_23['Total'].idxmax()

# post_2023_24 = incidence.loc[(incidence.index >= pd.to_datetime("2023-10-01")) & (incidence.index < pd.to_datetime("2024-10-01"))]
# post_2023_24_peak = post_2023_24['Total'].idxmax()

# post_2024_25 = incidence.loc[(incidence.index >= pd.to_datetime("2024-10-01")) & (incidence.index < pd.to_datetime("2025-10-01"))]
# post_2024_25_peak = post_2024_25['Total'].idxmax()
