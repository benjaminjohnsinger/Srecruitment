...
def get_jax_arrays_from_vax_csv(file, age_group_names=AGE_GROUP_NAMES):
...
# age_category_names = AGE_GROUP_NAMES
# age_categories = AGE_GROUPS

# age_name_mapping = dict(zip(['<3mo', '3-12mo', '1-4y', '5-7y', '8-39y', '40-64y', '>=65y'], AGE_GROUP_NAMES))

# demographics.loc[:,"age_category"] = demographics["age_category"].map(age_name_mapping)
...
#     turnover_rate = AGING_RATE[age_category_names.index(age_cat)]*30.44 # turnover rate per month
#     cumulative_prop = 0
#     cumulative_props = []
