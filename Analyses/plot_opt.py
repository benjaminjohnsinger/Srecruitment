...
params, p_time_to_obs, incidence, beta_params = pathogen_parameters(pathogen, lockdown, CONTACT)
...
elif option1 == 'setimport' or option1 == 'season_infections' or option1.replace('.','',1).isdigit():
...
ax[2].set_xticklabels(["","2016","","2018","","2020","","2022","","2024"])
plt.tight_layout()
...
# fig, ax = plt.subplots(figsize=(1.22,1.14))
# kpsc_positive_test_plot(ax,pathogen=pathogen,AGE_GROUPS=None,AGE_GROUP_NAMES=AGE_GROUP_NAMES, incidence=True, legend=False,aggregation="Month", color = "#DC267F")
# mx = lockdown_incidence_plot(ax,STATE0,params,OBS_AGE,PERIOD,POINTS,date_to_t('2020-03-19'),365,result=result,obs=obs,label="Simulation",by_age=False,AGE_GROUP_NAMES=AGE_GROUP_NAMES,factor=10000,p_time_to_obs=p_time_to_obs)
# lockdown_incidence_format(ax,date_to_t('2020-03-19'),365,mx,year_window=2)
# ax.set_xlabel("")
# ax.set_ylabel("")
# ax.set_xlabel("")
# ax.set_xticklabels(["","2016","","2018","","2020","","2022","","2024"], fontsize=6)
# # ax.set_xticklabels([])
# ax.set_yticks([])
# pnamedict = {"RSV":"RSV","InfluenzaA":"Flu A","InfluenzaB":"Flu B","Parainfluenza3":"PIV 3","Adenovirus":"AdV","Metapneumovirus":"hMPV"}
# ax.set_title(pnamedict[pathogen], fontsize=8)
# plt.tight_layout()
# plt.savefig("Figures/DE_"+pathogen+lockdown+option1+option2+str(seed)+"_mini.png", dpi=300)