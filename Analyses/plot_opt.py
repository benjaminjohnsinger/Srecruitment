...
likelihoods = np.zeros(35)
# print likelihood
for i in range(35):
    OBS_AGE[0] = 0.01 + i*0.01
    likelihoods[i] = SIS_likelihood(incidence,params,POINTS,STATE0,OBS_AGE,p_time_to_obs,age=True,incidence=True,overdispersion=False)
fig, ax = plt.subplots(figsize=(4,4))
ax.plot(0.02690762*(0.01+0.01*np.arange(35)),likelihoods,color='silver')
ax.axvline(x=0.02690762*0.0487,color='black',linestyle='--')
ax.text(0.02690762*0.05,-8300,"DE fit",rotation=90,verticalalignment='center',horizontalalignment='left',color='black')
ax.set_xlabel("Risk of hospitalization in infants")
ax.set_ylabel("Log-Likelihood")
plt.tight_layout()
plt.savefig("Figures/infant_OBS_likelihood_plot_"+pathogen+lockdown+option1+option2+str(seed)+".png",dpi=300)
