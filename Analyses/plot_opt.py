...
fig, ax = plt.subplots(figsize=(6.5/4,1.5))
...
mx = lockdown_incidence_plot(ax,STATE0,params,OBS_AGE,PERIOD,POINTS,date_to_t('2020-03-19'),365,result=result,obs=obs,label="Simulation",by_age=False,AGE_GROUP_NAMES=AGE_GROUP_NAMES,factor=10000,p_time_to_obs=p_time_to_obs,color='#648FFF')
lockdown_incidence_format(ax,date_to_t('2020-03-19'),365,mx,year_window=2)
# ax.set_title("Simulated incidence of "+pnamedict[pathogen])
ax.set_xlabel("")
ax.set_ylabel("")
ax.set_xlabel("")
ax.set_ylabel("")
...
ax.set_yticks([])
ax.set_xticklabels(["","2016","","2018","","2020","","2022","","2024"])
ax.set_title(pathogen_abbreviations[pnamedict[pathogen]])
plt.tight_layout()
