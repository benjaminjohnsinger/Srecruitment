...
if __name__ == "__main__":
   ...
   # prefix = "sampling_parameters_"
    ...
    params = x_to_params(x, pathogen, lockdown, option1, option2, print_params=False, return_contact=False, NAG=NAG, wrong_aging=int(str(seed)[:6])<260414, birth_rate_multiplier=birth_rate_multiplier)
    # print(cntct.shape)
    ...
    print(first_infectious_by_age.shape)
    print(first_infectious_by_age[0])
    print(MEDIAN_AGE_split)
    ...
    print(mean_age_of_first_infection.shape)
    print("Average age of first infection:", jnp.mean(mean_age_of_first_infection)/12)
