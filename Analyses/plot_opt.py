...
# # fig, ax = plt.figure(figsize=(13.3,7.5))
...
# mx = lockdown_incidence_plot(ax[0],STATE0,params,OBS_AGE,PERIOD,POINTS,date_to_t('2020-03-19'),365,result=result,obs=obs,label="Simulation",by_age=True,AGE_GROUP_NAMES=AGE_GROUP_NAMES,factor=10000,p_time_to_obs=p_time_to_obs)
# lockdown_incidence_format(ax[0],date_to_t('2020-03-19'),365,mx,year_window=2)
# ax[0].set_title("Simulated incidence of "+pnamedict[pathogen])
# ax[0].set_xlabel("")
# ax[0].set_ylabel("")
# ax[0].set_xlabel("")
# ax[0].set_xticklabels(["","2016","","2018","","2020","","2022","","2024"])
# # ax[0].set_yticks([])
# lockdown_susceptibility_plot(ax[1],STATE0,params,PERIOD,POINTS,date_to_t('2020-03-19'),result=result,relative=False,proportion=False, by_age=True,AGE_GROUP_NAMES=AGE_GROUP_NAMES)
# lockdown_susceptibility_format(ax[1],date_to_t('2020-03-19'),365,year_window=2,ymax=None,ymin=None)
...
# # plt.tight_layout()
# plt.savefig("Figures/DE_"+pathogen+lockdown+option1+option2+str(seed)+"_poster.svg",transparent=True)