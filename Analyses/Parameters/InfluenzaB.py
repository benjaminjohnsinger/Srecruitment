...
WANE = np.array([0.0,1/1000,0.0]) # Ferguson 2003
...
S_REL = np.array([1,0.4,0.16]) # maximum flu vaccine effectiveness is 60% (CDC)
I_REL = np.array([[1],[1],[1]])
# Probability of detection of cases for each susceptibility class
P_OBS_REL = np.array([1,1,1]) # simplest assumption in absence of data
P_OBS_MAX = 0.03
