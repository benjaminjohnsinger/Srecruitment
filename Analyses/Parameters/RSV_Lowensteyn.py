...
OBS_AGE = np.array([0.072,0.016,0.007,0.001,0.001,0.00001,0.00004])/(0.072*0.45)
## Other
# Seasonality parameters
SEASONALITY = 0.13
OFFSET = (274/365)+3.65/(2*np.pi)
# Infectiousness
# BETA = 0.054
BETA = 0.046
# BETA = 0.045
...
Fs = np.array([1,0.72,1,0.72,1]) # 0.2 minimum relative contact rate between COMIX and POLYMOD
# @jit
