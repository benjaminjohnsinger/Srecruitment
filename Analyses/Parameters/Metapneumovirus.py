...
REC_UP = np.array([1/4.9,1/4.1,0.0]) # Recovery to higher susceptibility class, same as RSV - Okiro 2010
REC_SAME = np.array([0.0,0.0,1/4.1]) # Recovery to same susceptibility class, same as RSV - Okiro 2010
